...
CWallet::TxItems CWallet::OrderedTxItems(std::list<CAccountingEntry>& acentries, std::string strAccount)
{
    ...
    // Note: maintaining indices in the database of (account,time) --> txnc and (account, time) --> acentry
                           ...
                           list<pair<CTxDestination, int64> >& listSent, int64& nFee, string& strSentAccount) const
{
    ...
    BOOST_FOREACH(const CTxOut& txout, vout)
    {
        ...
        {
            printf("CWalletTx::GetAmounts: Unknown transaction type found, txnc %s \n",
...
// XNC has hijacked it report inaccuracies in GetBalance() when stake is immature
