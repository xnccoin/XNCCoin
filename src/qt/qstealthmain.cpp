    ...
    : QLabel(parent)
{
    ...
    pages[k++] = pageSendXNC = new QPageSendXNC(this);
    pages[k++] = pageReceiveXNC = new QPageAddrBook(QPageAddrBook::ForEditing, QPageAddrBook::ReceivingTab, this);
...
void QStealthMain::setModel(WalletModel *model)
{
    ...
    pageSendXNC->setModel(model);
    pageReceiveXNC->setModel(model->getAddressTableModel());
...
void QStealthMain::showOutOfSyncWarning(bool fShow)
{
    ...
    pageSendXNC->showOutOfSyncWarning(fShow);
