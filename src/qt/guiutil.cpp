...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "XNC.lnk";
}
...
{
    return GetAutostartDir() / "XNC.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("XNC-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  XNC-qt [" + tr("command-line options") + "]                     " + "\n";
